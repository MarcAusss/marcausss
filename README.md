...
<div class="skills-container">
        ...
        <div class="skill">
            ...
            <div class="progress-bar">
                <div class="progress-bar-inner html" data-progress="90%">90%</div>
            </div>
        </div>
        <div class="skill">
            <div class="skill-name">PHP</div>
            <div class="progress-bar">
                <div class="progress-bar-inner php" data-progress="70%">70%</div>
            </div>
        </div>
        <div class="skill">
            <div class="skill-name">Laravel</div>
            <div class="progress-bar">
                <div class="progress-bar-inner laravel" data-progress="80%">80%</div>
            </div>
        </div>
        <div class="skill">
            <div class="skill-name">CSS</div>
            <div class="progress-bar">
                <div class="progress-bar-inner css" data-progress="90%">90%</div>
            </div>
        </div>
        <div class="skill">
            <div class="skill-name">Tailwind</div>
            <div class="progress-bar">
                <div class="progress-bar-inner tailwind" data-progress="90%">90%</div>
            </div>
        </div>
    </div>
